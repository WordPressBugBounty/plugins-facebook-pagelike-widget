...
class Settings
{
    ...
    {
        // Register options
        register_setting(BZ_SOCIAL_FEEDS_NAME, BZ_SOCIAL_FEEDS_NAME . "_settings", [
            'type' => 'array',
        ...
        // Load settings
        self::$settings = get_option(BZ_SOCIAL_FEEDS_NAME . "_settings", []);
    }
    ...
    public static function saveUpdatedSettings(): bool
    {
        ...
        // Save setting
        update_option(BZ_SOCIAL_FEEDS_NAME . '_settings', self::$settings);
