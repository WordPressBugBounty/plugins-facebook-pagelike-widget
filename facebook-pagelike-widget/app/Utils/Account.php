...
class Account
{
    ...
    {
        // Register options
        register_setting(BZ_SOCIAL_FEEDS_NAME, BZ_SOCIAL_FEEDS_NAME . "_account", [
            'type' => 'array',
        ...
        // Load settings
        self::$data = get_option(BZ_SOCIAL_FEEDS_NAME . "_account", []);
    }
    ...
    public static function syncToDatabase(object $data): bool
    {
        ...
        // Save account data
        update_option(BZ_SOCIAL_FEEDS_NAME . '_account', self::$data);
